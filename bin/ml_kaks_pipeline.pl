...
=head1 Version
  ...
  Author: Li Lei(lilei_leo007@gmail.com)
  Version: 1.1 Date: 2011-09-01
...
#Modified 20110901: change the model for codons to 0, and NSsites points to positive selection sites
#Modified 20110920: change the model for codons to 7,8, and NSsites points to positive selection sites
###################################################
sub RunCodeml{
...
#die"There are codeml.ctl exist\n" if (-e 'codeml.ctl');
    ...
    CodonFreq = 2   * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
      ...
      NSsites = 1 2 7 8   * dN/dS among sites. 0:no variation, 1:neutral, 2:positive
